...
OUTPUT_DIR = PROJECT_ROOT / "outputs" / "final_evaluation"
RESTORED_DIR = OUTPUT_DIR / "restored"
COMPARISON_DIR = OUTPUT_DIR / "comparisons"
CSV_PATH = RESULTS_DIR / "final_test_results.csv"
SUMMARY_PATH = RESULTS_DIR / "final_test_summary.txt"
...
def main():
    ...
    print("=" * 70)
    print("KLA FINAL NOISE-AWARE DnCNN BENCHMARK")
    print("=" * 70)
    ...
    # Use the exact same split logic as evaluate_noise_aware.py
    pairs = build_pairs()
    ...
    summary = (
        "KLA FINAL NOISE-AWARE DnCNN BENCHMARK\n"
        "======================================================================\n"
